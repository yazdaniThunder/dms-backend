...
public class JalaliCalendar extends Calendar {
    ...
    public static String getJalaliDate(Date gDate) {
        ...
        String month = String.valueOf(jDate.month + 1).length() != 2 ? "0" + (jDate.month + 1) : String.valueOf(jDate.month + 1);
        String days = String.valueOf(jDate.date).length() != 2 ? "0" + (0 + jDate.date) : String.valueOf(jDate.date);

        String jalali = jDate.year + "/" + month + "/" + days;

        return jalali;
    }

    public static String getJalaliYear(Date gDate) {
        ...
        String jalaliYear = String.valueOf(jDate.year);

        return jalaliYear;
    }

    public static YearMonthDate getJalaliFullDate(Date gDate) {
    ...
    public static String getJalali(Date gDate) {
    ...
    public static List<String> getBetweenDates(Instant startInstant, Instant endInstant) {

        LocalDate startLocalDate = startInstant.atZone(ZoneId.systemDefault()).toLocalDate().minusDays(1);
        ...
        return IntStream.iterate(0, i -> i + 1)
                ...
                .mapToObj(i -> getJalaliDate(Date.from(startLocalDate.plusDays(i).atStartOfDay(ZoneId.systemDefault()).toInstant())))
                .collect(Collectors.toList());

    }

//    public static void main(String[] args) {
//        Instant startInstant = Instant.parse("2023-09-21T20:30:00.000Z");
//        LocalDate startDate = startInstant.atZone(ZoneId.systemDefault()).toLocalDate().minusDays(1);
//
//        Instant endInstant = Instant.parse("2023-10-18T20:30:00.000Z");
//        LocalDate endDateDate = endInstant.atZone(ZoneId.systemDefault()).toLocalDate();
//
//        long numOfDaysBetween = ChronoUnit.DAYS.between(startDate, endDateDate);
//
//        List<String> collect = IntStream.iterate(0, i -> i + 1)
//                .limit(numOfDaysBetween)
//                .mapToObj(i -> getJalaliDate(Date.from(startDate.plusDays(i).atStartOfDay(ZoneId.systemDefault()).toInstant())))
//                .collect(Collectors.toList());
//
